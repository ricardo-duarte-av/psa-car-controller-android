...
val CHANGELOG: List<ChangelogVersion> = listOf(
    ...
    ChangelogVersion(
        ...
        date = "25/09/2026",
        changes = listOf(
            "In step with server 0.1.29, which reads the trips the car logs itself the way the " +
                "official app does (a diagnostic for now).",
        ),
    ),
    ChangelogVersion(
        version = "0.1.28",
    ...
    ChangelogVersion(
        ...
        date = "24/09/2026",
        changes = listOf(
            "In step with server 0.1.27, whose request retried after renewing PSA's login is no " +
                "longer refused.",
        ),
    ),
    ChangelogVersion(
    ...
    ChangelogVersion(
        ...
        date = "24/09/2026",
        changes = listOf(
            "In step with server 0.1.25, which no longer loses a request to PSA every hour when its " +
                "login expires.",
        ),
    ),
    ChangelogVersion(
